...
matmul_avx2_O3:     file format elf64-x86-64
...
0000000000401330 <matrix_multiply_avx2>:
  ...
  401394:	4a 8d 04 32          	lea    (%rdx,%r14,1),%rax
  ...
  4013d0:	c5 f2 58 c3          	vaddss %xmm3,%xmm1,%xmm0
  4013d4:	c5 f0 c6 e1 55       	vshufps $0x55,%xmm1,%xmm1,%xmm4
  4013d9:	c5 f0 c6 d1 ff       	vshufps $0xff,%xmm1,%xmm1,%xmm2
  4013de:	49 83 c5 04          	add    $0x4,%r13
  4013e2:	c5 fa 58 c4          	vaddss %xmm4,%xmm0,%xmm0
  4013e6:	c5 f0 15 e1          	vunpckhps %xmm1,%xmm1,%xmm4
  4013ea:	c4 e3 7d 19 c9 01    	vextractf128 $0x1,%ymm1,%xmm1
  4013f0:	c5 fa 58 c4          	vaddss %xmm4,%xmm0,%xmm0
  4013f4:	c5 fa 58 c2          	vaddss %xmm2,%xmm0,%xmm0
  4013f8:	c5 f0 c6 d1 55       	vshufps $0x55,%xmm1,%xmm1,%xmm2
  4013fd:	c5 fa 58 c1          	vaddss %xmm1,%xmm0,%xmm0
  401401:	c5 fa 58 c2          	vaddss %xmm2,%xmm0,%xmm0
  401405:	c5 f0 15 d1          	vunpckhps %xmm1,%xmm1,%xmm2
